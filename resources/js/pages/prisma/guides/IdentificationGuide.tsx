...
export default function IdentificationGuide() {
  return (
    <Box sx={{ maxHeight: '74.5vh', overflowY: 'auto', pr: 1 }}>
      <GuideInfo>
        Tahap Identification digunakan untuk mengambil metadata artikel
        berdasarkan keyword yang telah ditentukan. Panel ini akan memandu Anda
        dalam menggunakan fitur Identification untuk melakukan pencarian dan
