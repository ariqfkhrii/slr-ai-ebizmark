...
export const fallbackReportItems = [
  ...
  },
  {
    ...
    detail:
      'Describe the methods used to synthesise results and provide a rationale for the choice(s).',
    status: 'draft',
    order_no: 11,
    generated_content: '',
    word_count: 0,
  ...
  },
  {
    ...
    detail:
      'Describe the results of the search and selection process, from the number of records identified to the number of studies included.',
    status: 'draft',
    order_no: 14,
    generated_content: '',
    word_count: 0,
  },
  {
    ...
    detail: 'Cite each included study and present its characteristics.',
    status: 'draft',
    order_no: 15,
    generated_content: '',
    word_count: 0,
  },
  {
    ...
    detail: 'Present assessments of risk of bias for each included study.',
    status: 'draft',
    order_no: 16,
    generated_content: '',
    word_count: 0,
  },
  {
    ...
    detail:
      'Present the findings of each study, including summary statistics and effect estimates where appropriate.',
    status: 'draft',
    order_no: 17,
    generated_content: '',
    word_count: 0,
  },
  {
    ...
    detail: 'Present results of all statistical syntheses conducted.',
    status: 'draft',
    order_no: 18,
    generated_content: '',
    word_count: 0,
  ...
  },
  {
    id: 'discussion-2',
    chapter: 'Discussion',
    title: 'Limitations of Evidence',
    detail: 'Discuss any limitations of the evidence included in the review.',
    status: 'draft',
    order_no: 22,
    generated_content: '',
    word_count: 0,
  },
  {
    id: 'discussion-3',
    chapter: 'Discussion',
    title: 'Limitations of Review Process',
    detail: 'Discuss any limitations of the review processes used.',
    status: 'draft',
    order_no: 23,
    generated_content: '',
    word_count: 0,
  },
  {
    id: 'discussion-4',
    chapter: 'Discussion',
    title: 'Implications for Practice, Policy, and Future Research',
    detail:
...
export function useAutoReporting(props: any) {
  ...
  const generatedCount = rawItems.filter(
  ...
  const currentGroup =
    groupedItems.find((group) => group.chapter === activeChapter) ??
    groupedItems[0];
